...
//CommandData operations
void command_change_data(CommandQueue *cq, void *data);
CommandData *command_get_data(CommandQueue *cq, int command);

//Free or reuse CommandQueue
void clear_command_queue(CommandQueue *cq);
bool reset_command_queue(CommandQueue *cq);
void free_command_queue(CommandQueue *cq);

//CommandQueue specializations
